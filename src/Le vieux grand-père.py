...
tts.say("Il était une fois un pauvre homme bien vieux, \\pau=200\\qui avait les yeux trouble,\\pau=200\\ "\
        ...
        "de sa bouche.\\pau=600\\ La femme de son fils et son fils lui-mème en avaient pris un grand \\rspd=85\\daigoût, \\pau=200\\"\
        ...
        "et regardait tristement du coter de la table...\\pau=1000\\")
...
tts.say("Quelques jours après,\\pau=200\\ son fils et sa belle-fille virent leur enfant qui avait quatre ans,\\pau=200\\ occupé \\pau=120\\"\
        ...
        "son père.\\pau=600\\ \\vct=150\\C'est un auget, \\pau=200\\ \\vct=100\\ répondit-il,\\pau=200\\ \\vct=150\\pour donner À manger "\
        "à papa et maman quand ils seront vieux.\\vct=100\\ \\pau=1000\\")
